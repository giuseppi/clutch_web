    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        <p className="text-muted-foreground max-w-md mx-auto mt-4 text-lg">
          Clutch is coming soon to iOS, Android, and Web.
        </p>

        {/* Grayed-out "Coming Soon" platform buttons */}
        <div className="flex flex-col sm:flex-row gap-3 justify-center items-center mt-10">
          <button
            disabled
            className="bg-foreground/40 text-background/60 px-8 py-4 rounded-lg font-bold text-base flex items-center justify-center gap-3 w-full sm:w-auto opacity-50 cursor-not-allowed"
          >
        ...
        <div className="mt-14 max-w-md mx-auto">
          <div className="glass-panel rounded-xl p-6 border border-border text-left">
            <h3 className="text-sm font-bold text-foreground">
              Get notified when the beta comes out.
            </h3>
            <p className="text-xs text-muted-foreground mt-1">
              Be the first to try Clutch. No spam.
            </p>
